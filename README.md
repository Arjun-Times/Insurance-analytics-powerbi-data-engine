# Insurance Performance & Customer Insights - Power BI Data Engine

## Project Overview
This project transforms raw insurance policy data into a comprehensive analytical ecosystem. While many reports focus solely on visual trends, this solution is designed as a data-centric portal, allowing stakeholders to extract accurate, requirement-specific data and validated KPIs at both a macro and granular level.

The dashboard provides a "Single Source of Truth" for insurance operations, moving beyond simple visualization to act as a reliable data provisioning tool for agents and management.
